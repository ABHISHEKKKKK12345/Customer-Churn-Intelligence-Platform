...
#  Launch via .exe or `python churn_analytics_gui.py`
# ==============================================================================
...
APP_VERSION = "v2.0  ·  MBA Final Project"
AUTHOR      = "Abhishek  |  Roll No. 24154041051  |  MBA Business Analytics, MAHE"
...
class SplashScreen:
    def __init__(self):
        ...
        tk.Label(inner, text="MBA Final Project  ·  Business Analytics",
                 font=("Segoe UI", 10),
